   ...
   extends FGUtilCore
 {
   ...
   public NPUtil(NoobProtect plugin, boolean vcheck, boolean savelng, String language, String devbukkitname, String version_name, String plgcmd, String px)
   {
   ...
   public void PrintCfg(CommandSender p) {
     printMsg(p, "&6&lNoobProtector v" + this.des.getVersion() + " &r&6| " + getMSG(new Object[] { "cfg_configuration", Character.valueOf('6') }));
     printMSG(p, new Object[] { "msg_currenttime", getServerTime("") });
     printMSG(p, new Object[] { "msg_servertimezone", TimeZone.getDefault().getDisplayName() });
     printMSG(p, new Object[] { "msg_cfgtimezone", this.plg.timezone });
     printMSG(p, new Object[] { "msg_currenttime", getServerTime(this.plg.timezone) });
     printEnDis(p, "msg_joinprotect", this.plg.joinprotect);
     printEnDis(p, "msg_playerwarn", this.plg.playerwarn);
     printMSG(p, new Object[] { "msg_playerwarntime", Integer.valueOf(this.plg.playerwarntime) });
     printEnDis(p, "msg_useplaytime", this.plg.useplaytime);
     printMSG(p, new Object[] { "msg_useplaytimevalue", Integer.valueOf(this.plg.prtplay) });
     printEnDis(p, "msg_userealtime", this.plg.userealtime);
     printMSG(p, new Object[] { "msg_userealtimevalue", Integer.valueOf(this.plg.prttime) });
     printMSG(p, new Object[] { "msg_pvponcooldowntime", Integer.valueOf(this.plg.pvponcooldown) });
     printMSG(p, new Object[] { "msg_pvpupdatetime", Integer.valueOf(this.plg.pvpupdatetime) });
     printMSG(p, new Object[] { "msg_language", this.plg.language });
     printEnDis(p, "msg_versioncheck", this.plg.version_check);
   }
