...
import com.thunder.Items.IEnergyShield3;
...
public class ShieldRenderer3 implements IItemRenderer 
{
	 private final float scale;
	 private static final ResourceLocation RES_ITEM_GLINT = new ResourceLocation("textures/misc/enchanted_item_glint.png");
	   
	   public ShieldRenderer3(float scale)
	   {
	     this.scale = scale;
	   }
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data)
	   ...
	   private void renderEntity(ItemStack stack)
	   {
		   ...
		   IEnergyShield3 sh1 = (IEnergyShield3) item;
		    ...
		    if(sh1.isActive(stack))
		    {
		        ...
		        //float f7 = 0.76F;
		        GL11.glColor4f(0.9F, 0.7F, 0.0F, 1.0F);
