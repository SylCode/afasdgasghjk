...
public class IEnergyStimulatorStr3 extends ElectricItemBase{
	
	private ChatComponentText chat;
	private int power = Config.StrStimLvl3EffectPower + 1;


	public IEnergyStimulatorStr3(){
		super();
		this.setCreativeTab(EnergyAdditionsCore.tabEnergyAdditions);
		this.maxCharge = Config.StrStimLvl3maxCharge;
		this.transferLimit = Config.StrStimLvl3TransferLimit;
		this.tier = Config.StrStimLvl3Tier;
	...
	public ItemStack onItemRightClick(ItemStack Item, World world, EntityPlayer player)
	{
		...
		if(ElectricItem.manager.use(Item, Config.StrStimLvl3ChargeToUse, player))
		{
			...
			player.addPotionEffect(new PotionEffect(Potion.damageBoost.getId(), 20*Config.StrStimLvl3EffectDuration, Config.StrStimLvl3EffectPower));
	...
	public void addInformation(ItemStack Item, EntityPlayer player, List par3List, boolean par4)
	{
		  par3List.add(EnumChatFormatting.GRAY + StatCollector.translateToLocal("tag.items.general.onright"));
		    ...
		    par3List.add(EnumChatFormatting.GRAY + StatCollector.translateToLocal("tag.items.stim.consumes") + Config.StrStimLvl3ChargeToUse + " Eu");
