...
public class IStunModule extends ElectricItemBase {
	
	public IStunModule(){
		super();
		this.setCreativeTab(EnergyAdditionsCore.tabEnergyAdditions);
		this.maxCharge = Config.SModuleMaxCharge;
		this.transferLimit = Config.SModuleTransferLimit;
		this.tier = Config.SModuleTier;
	 ...
	 public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer entityplayer)
	  {
	    ...
	    if (nbtData.getBoolean("activeS"))
	    {
	      nbtData.setBoolean("activeS", false);
	      updateAttributes(nbtData);
	    }
	    else if (ElectricItem.manager.canUse(itemStack, 5.0D))
	    {
	      nbtData.setBoolean("activeS", true);
	      updateAttributes(nbtData);
	 ...
	 public static int ticker = 0;
	  ...
	  public void onUpdate(ItemStack itemStack, World world, Entity entity, int slot, boolean par5)
	  {
	    ...
	    if ((ticker % 16 == 0) && ((entity instanceof EntityPlayerMP))) {
	        drainModule(itemStack, Config.SModuleDrain, (EntityPlayer)entity);
	      }
	    }
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List par3List, boolean par4)
	{
	  ...
	  {
	    boolean active = nbtData.getBoolean("activeS");
