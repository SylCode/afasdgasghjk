...
public class IEnergySaber extends ElectricToolBase {
	...
	public IEnergySaber(int operationEnergyCost, ElectricToolBase.HarvestLevel harvestLevel){
	  ...
	  public void registerIcons(IIconRegister iconRegister)
	  {
	    ...
	    this.textures[1] = iconRegister.registerIcon("thunder:" + getUnlocalizedName().substring(5) + "ActiveExtra");
