...
public class AgonyIncubationPotion extends Potion {
	
	public static AgonyIncubationPotion agony;
	...
	public AgonyIncubationPotion(int id1, boolean badEffect, int liquidColor)
	  {
	...
	public void renderInventoryEffect(int x, int y, PotionEffect effect, net.minecraft.client.Minecraft mc)
	{
		...
		if (this.stackIcon == null) this.stackIcon = new ItemStack(Items.bone);
