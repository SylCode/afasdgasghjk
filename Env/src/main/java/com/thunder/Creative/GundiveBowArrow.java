...
public class GundiveBowArrow extends EntityArrow implements IEntityAdditionalSpawnData
{
    ...
    public GundiveBowArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public GundiveBowArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public GundiveBowArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public GundiveBowArrow(World world, EntityLivingBase player, float speed, float damage)
    {
        super(world);
        this.damage = damage;
        this.renderDistanceWeight = 10.0D;
    ...
    public GundiveBowArrow(World world, EntityLivingBase player, float speed, float damage, double x, double y, double z)
    {
        super(world);
        this.damage = damage;
        this.renderDistanceWeight = 10.0D;
        ...
        this.setSize(0.5F, 0.5F);
        this.setLocationAndAngles(player.posX + x, player.posY + (double)player.getEyeHeight() + y, player.posZ + z, player.rotationYaw, player.rotationPitch);
        this.posX -= (double)(MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * 0.16F);
        this.posY -= 0.10000000149011612D;
        this.posZ -= (double)(MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * 0.16F);
        this.setPosition(this.posX, this.posY, this.posZ);
                ...
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                    {
                        ...
                        if (movingobjectposition.entityHit instanceof EntityLivingBase){
                        	...
                        	EntityLivingBase entityL = (EntityLivingBase)movingobjectposition.entityHit;
                        	entityL.addPotionEffect(new PotionEffect(Potion.poison.id, 100 , 5));
                        }
