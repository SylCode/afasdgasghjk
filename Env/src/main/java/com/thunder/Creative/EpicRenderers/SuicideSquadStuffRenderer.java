...
public class SuicideSquadStuffRenderer implements IItemRenderer 
{
	 private final float scale;
	 private static final ResourceLocation RES_ITEM_GLINT = new ResourceLocation("textures/misc/enchanted_item_glint.png");
	 private int pass = 0;
	   
	   public SuicideSquadStuffRenderer(float scale)
	   {
	     this.scale = scale;
	   }
	...
	public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data)
	   ...
	   private void renderEquippedItem(ItemStack stack, EntityLivingBase entity, boolean firstPerson)
	   {
	     ...
	     if (firstPerson) {
	       f *= 1.2F;
	       GL11.glTranslatef(-0.2F, -0.2F * this.scale, -0.3F);
	       GL11.glScalef(f, f, f);
	       ...
	       f =1.1F;
	       GL11.glTranslatef(1.0F - f, -0.2F * this.scale, 0.2F * this.scale);
        ...
        OpenGlHelper.glBlendFunc(768, 1, 1, 0);
        float f7 = 0.76F;
        GL11.glColor4f(0.0F, f7, 0.0F, 0.3F);
        GL11.glMatrixMode(GL11.GL_TEXTURE);
        GL11.glPushMatrix();
        float f8 = 0.125F;
        GL11.glScalef(f8, f8, f8);
