...
import com.thunder.Creative.IGundiveBow;
import com.thunder.Creative.IGundiveBow.BowMode;
...
public class EpicBowRenderer implements IItemRenderer 
{
	 private final float scale;
	 private static final ResourceLocation RES_ITEM_GLINT = new ResourceLocation("textures/misc/enchanted_item_glint.png");
	 private int pass = 0;
	   
	   public EpicBowRenderer(float scale)
	   {
	     this.scale = scale;
	   }
	   ...
	   private void renderEntity(ItemStack stack)
	   {
		   ...
		   IGundiveBow b = (IGundiveBow)item;
		   ...
		   ItemRenderer.renderItemIn2D(tessellator, icon.getMaxU(), icon.getMinV(), icon.getMinU(), icon.getMaxV(), icon.getIconWidth(), icon.getIconHeight(), 0.0625F);
            ...
            float f7 = 0.76F;
            if(b.getBowMode(stack).equalsIgnoreCase("massive"))
            	GL11.glColor4f(1.0F * f7, 0, 0, 1);
            else 
            	GL11.glColor4f(0, 0, 1.0F*f7, 1);
	   ...
	   private void renderEquippedItem(ItemStack stack, EntityLivingBase entity, boolean firstPerson)
	   {
	     ...
	     if (firstPerson) {
	       f *= 1.2F;
	       GL11.glTranslatef(-0.5F, -0.2F * this.scale, -0.1F);
	       GL11.glScalef(f, f, f);
	       GL11.glRotatef(-5.0F, 0.0F, 0.0F, 1.0F);
	       GL11.glRotatef(-5.0F, 0.0F, 1.0F, 0.0F);
	     } else {
	       f =1.1F;
	       GL11.glTranslatef(0.9F - f, -0.5F * this.scale, 0.2F * this.scale);
