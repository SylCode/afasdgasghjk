...
public class VampPotion extends Potion {	
	...
	public VampPotion(int id1, boolean badEffect, int liquidColor)
	  {
	...
	public void renderInventoryEffect(int x, int y, PotionEffect effect, net.minecraft.client.Minecraft mc)
	{
		...
		if (this.stackIcon == null) this.stackIcon = new ItemStack(CreativeItemList.VampiricElixir);
