...
public class RecipeList {
    ...
    //    ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterJetPack, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), JetPack, Character.valueOf('R'), IC2Items.getItem("glassFiberCableItem"), Character.valueOf('C'), ItemList.DiamondInlaidCircuit});
     //   ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterJetPack, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), JetPack, Character.valueOf('R'), new RecipeInputOreDict("cableGt01Platinum"), Character.valueOf('C'), ItemList.DiamondInlaidCircuit});
        	
        //str
  //      ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdater1, 1), new Object[] {"CEC", "RDR", "CRC", Character.valueOf('D'), ItemList.UpdaterCore, Character.valueOf('E'), ItemList.EnergyStimulatorExtractStr, Character.valueOf('R'), IC2Items.getItem("insulatedGoldCableItem"), Character.valueOf('C'), IC2Items.getItem("electronicCircuit")});
  //      ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdater1, 1), new Object[] {"CEC", "RDR", "CRC", Character.valueOf('D'), ItemList.UpdaterCore, Character.valueOf('E'), ItemList.EnergyStimulatorExtractStr, Character.valueOf('R'), new RecipeInputOreDict("cableGt01Gold"), Character.valueOf('C'), IC2Items.getItem("electronicCircuit")});
        
  //      ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterCombat2, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), UpdatersList.EnergyUpdater1, Character.valueOf('R'), IC2Items.getItem("glassFiberCableItem"), Character.valueOf('C'), ItemList.DiamondInlaidCircuit});
  //      ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterCombat2, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), UpdatersList.EnergyUpdater1, Character.valueOf('R'), new RecipeInputOreDict("cableGt01Platinum"), Character.valueOf('C'), ItemList.DiamondInlaidCircuit});
        
  //      ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterCombat3, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), UpdatersList.EnergyUpdaterCombat2, Character.valueOf('R'), IC2Items.getItem("glassFiberCableItem"), Character.valueOf('C'), ItemList.IridiumInlaidCircuit});
  //     ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterCombat3, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), UpdatersList.EnergyUpdaterCombat2, Character.valueOf('R'), new RecipeInputOreDict("cableGt01Platinum"), Character.valueOf('C'), ItemList.IridiumInlaidCircuit});
        //falling
