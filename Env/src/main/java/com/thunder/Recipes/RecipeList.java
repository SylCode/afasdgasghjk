...
public class RecipeList {
	...
	public static void Recipes(){
        ...
        ItemStack energyCharger = new ItemStack(BlockList.EnergyCharger).copy();
        energyCharger.setItemDamage(OreDictionary.WILDCARD_VALUE);
        
        
        //OreDictSupport (Mostly for GT5/6)
        
        //ores
        if(!Config.CraftsWithEnergyOre){
        GameRegistry.addSmelting(BlockList.EnergyOre, new ItemStack(ItemList.EnergyIngot, 1), 5.0f);
        GameRegistry.addSmelting(ItemList.EnergyDust, new ItemStack(ItemList.EnergyIngot, 1), 2.5f);
        GameRegistry.addShapelessRecipe(new ItemStack(ItemList.EnergyNugget, 9), new Object[]{ ItemList.EnergyIngot});
        GameRegistry.addRecipe(new ItemStack(ItemList.EnergyIngot, 1), new Object[]{ "###", "###", "###", ('#'), ItemList.EnergyNugget});
        GameRegistry.addShapelessRecipe(new ItemStack(ItemList.EnergyIngot, 9), new Object[]{ BlockList.BlockEnergyOre});
        GameRegistry.addRecipe(new ItemStack(BlockList.BlockEnergyOre, 1), new Object[]{ "###", "###", "###", ('#'), ItemList.EnergyIngot});
        
        //test recipes
        
        ic2.api.recipe.Recipes.compressor.addRecipe(new RecipeInputItemStack(new ItemStack(ItemList.EnergyIngot, 1)), null, new ItemStack(ItemList.EnergyPlate, 1));
        ic2.api.recipe.Recipes.macerator.addRecipe(new RecipeInputItemStack(new ItemStack(BlockList.EnergyOre, 1)), null, new ItemStack(ItemList.EnergyDust, 2));
        ic2.api.recipe.Recipes.metalformerRolling.addRecipe(new RecipeInputItemStack(new ItemStack(ItemList.EnergyPlate, 1)), null, new ItemStack(ItemList.EnergyRod, 1));
        ...
        if(Config.AdvancedEnergyChargerCraft){
        	ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(BlockList.AdvancedEnergyCharger, 1), new Object[] {"CIC", "IMI", "CIC",  Character.valueOf('M'), energyCharger,  Character.valueOf('C'), ItemList.IridiumInlaidCircuit,  Character.valueOf('I'), ULenergyCrystal});	

        }
        //energy binder
        if(Config.EnergyBinderCraft){
        	ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(ItemList.EnergyBinder, 1), new Object[] {"LCL", "LML", "LIL",  Character.valueOf('M'), ItemList.EnergyShieldMagnetCoil,  Character.valueOf('C'), ItemList.DiamondInlaidCircuit,  Character.valueOf('I'), IC2Items.getItem("wrench"),  Character.valueOf('L'), new RecipeInputOreDict("plateLapis")});	
 ...
 //       ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterAddExtraDamage3, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), UpdatersList.EnergyUpdaterAddExtraDamage2, Character.valueOf('R'), new RecipeInputOreDict("cableGt01Platinum"), Character.valueOf('C'), ItemList.IridiumInlaidCircuit});
	...
	}else if(Config.CraftsWithEnergyOre){
       ...
       //ARMOR NEW
        ...
        //core
        if(Config.UpdaterCoreCraft == true){
        ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(ItemList.UpdaterCore, 1), new Object[] {"IRI", "LCL", "IRI", Character.valueOf('I'), ItemList.EnergyIngot, Character.valueOf('L'), ItemList.EnergyPlate, Character.valueOf('R'), IC2Items.getItem("electronicCircuit"), Character.valueOf('C'), energyCrystal});
        }
        //matrix
        if(Config.MatrixCraft == true){
        ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyMatrix, 1), new Object[] {" R ", "RCR", " R ", Character.valueOf('R'), IC2Items.getItem("electronicCircuit"), Character.valueOf('C'), energyCrystal});
 ...
 //       ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(UpdatersList.EnergyUpdaterAddExtraDamage3, 1), new Object[] {"CRC", "RDR", "CRC", Character.valueOf('D'), UpdatersList.EnergyUpdaterAddExtraDamage2, Character.valueOf('R'), new RecipeInputOreDict("cableGt01Platinum"), Character.valueOf('C'), ItemList.IridiumInlaidCircuit});
       ...
       if(Config.UltimateEnergyCraft == true){
        ...
        if(Config.EnergySaberCore == true){
        	ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(ItemList.EnergySaberCore, 1), new Object[] {"CDC", "DND", "CDC",  Character.valueOf('C'), ItemList.EnergyPlate, Character.valueOf('N'), ItemList.NuclearComponent, Character.valueOf('D'), ItemList.DiamondInlaidCircuit});      	
        }
        if(Config.ModificatorCore == true){
        	ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(ItemList.ModificatorCore, 1), new Object[] {" ID", "MPC", " ID",  Character.valueOf('I'), new RecipeInputOreDict("plateIron"), Character.valueOf('D'), IC2Items.getItem("glassFiberCableItem"), Character.valueOf('C'), IC2Items.getItem("FluidCell"), Character.valueOf('P'), ItemList.DiamondInlaidCircuit, Character.valueOf('M'),new RecipeInputOreDict("plateCopper")});
        	ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(ItemList.ModificatorCore, 1), new Object[] {" ID", "MPC", " ID",  Character.valueOf('I'), new RecipeInputOreDict("plateIron"), Character.valueOf('D'), new RecipeInputOreDict("cableGt01Platinum"), Character.valueOf('C'), IC2Items.getItem("FluidCell"), Character.valueOf('P'), ItemList.DiamondInlaidCircuit, Character.valueOf('M'),new RecipeInputOreDict("plateCopper")});
        ...
        //shields parts
        if(Config.EnergyShieldMagnet == true)
    	GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ItemList.EnergyShieldMagnet, 1), new Object [] {"IGI", "GEG", "IGI", Character.valueOf('I'), ItemList.EnergyPlate, Character.valueOf('G'), IC2Items.getItem("advancedAlloy"), Character.valueOf('E'), "plateDenseIron"}));
        if(Config.EnergyShieldMagnetCoil == true)
    	GameRegistry.addRecipe(new ItemStack(ItemList.EnergyShieldMagnetCoil, 1), new Object [] {"III", "LEL", "III", Character.valueOf('L'), ItemList.EnergyRod, Character.valueOf('I'), IC2Items.getItem("coil"),Character.valueOf('E'), ItemList.EnergyShieldMagnet});
        if(Config.EnergyShieldCore == true)
    	GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ItemList.EnergyShieldCore, 1), new Object [] {"IGI", "GEG", "IGI", Character.valueOf('I'), ItemList.EnergyPlate, Character.valueOf('G'), ItemList.EnergyShieldMagnetCoil, Character.valueOf('E'), IC2Items.getItem("advancedCircuit")}));
        //iridium circuit
        if(Config.IridiumCircuit == true){
        ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(ItemList.IridiumInlaidCircuit, 1), new Object[] {"CDC", "DRD", "CTC",  Character.valueOf('C'), IC2Items.getItem("insulatedGoldCableItem"), Character.valueOf('R'), ItemList.DiamondInlaidCircuit, Character.valueOf('D'), IC2Items.getItem("iridiumOre"), Character.valueOf('T'), new RecipeInputOreDict("craftingToolWireCutter")});
        ic2.api.recipe.Recipes.advRecipes.addRecipe(new ItemStack(ItemList.IridiumInlaidCircuit, 1), new Object[] {"CDC", "DRD", "CTC",  Character.valueOf('C'), new RecipeInputOreDict("cableGt01Gold"), Character.valueOf('R'), ItemList.DiamondInlaidCircuit, Character.valueOf('D'), IC2Items.getItem("iridiumOre"), Character.valueOf('T'), new RecipeInputOreDict("craftingToolWireCutter")});
