...
public class PacketDispatcher
{
	...
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(EnergyAdditionsInfo.MODID);

	public static final void preInit() {
		
		registerMessage(OpenGuiMessage.class);
		registerMessage(SyncPlayerMessage.class);
