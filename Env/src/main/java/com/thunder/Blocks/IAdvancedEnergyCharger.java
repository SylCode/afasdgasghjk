...
public class IAdvancedEnergyCharger extends BlockContainer {
	
	private ChatComponentText chat;
	
	public IAdvancedEnergyCharger(){
		super(Material.iron);
	...
	public void registerBlockIcons(IIconRegister Icon){
		...
		this.blockIcon = Icon.registerIcon("thunder:" + "AdvancedEnergyCharger");
	}
	...
	public void getSubBlocks(Item item, CreativeTabs tab, List stackList){
		...
		StackUtil.getOrCreateNbtData(full).setInteger("energy", 400000000);
		stackList.add(full);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int var6, float var7, float var8, float var9){
		...
		AdvancedEnergyChargerTileEntity te = (AdvancedEnergyChargerTileEntity) world.getTileEntity(x, y, z);
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		...
		return new AdvancedEnergyChargerTileEntity();
	}
