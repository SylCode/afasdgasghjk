...
public class IEnergyMatrixUltra extends ElectricItemBase implements IEnergyAdd{
	...
	public void registerIcons(IIconRegister Icon){
	 ...
	 @SideOnly(Side.CLIENT)
		...
		{	
		 	par3List.add(EnumChatFormatting.GRAY + StatCollector.translateToLocal("tag.matrix.type.ultra"));
