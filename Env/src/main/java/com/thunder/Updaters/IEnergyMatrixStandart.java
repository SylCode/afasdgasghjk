...
public class IEnergyMatrixStandart extends ElectricItemBase implements IEnergyAdd{
	
	IEnergyMatrixStandart(){
		super();
	...
	public void registerIcons(IIconRegister Icon){
	 ...
	 @SideOnly(Side.CLIENT)
		...
		{	
		 	par3List.add(EnumChatFormatting.GRAY + StatCollector.translateToLocal("tag.matrix.type.standart"));
