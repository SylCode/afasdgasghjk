...
public class IEnergyUpdaterCombat2 extends IEnergyUpdater implements IEnergyAdd {
	
	IEnergyUpdaterCombat2(){
		super();
	...
	protected String getEffect(){
		return "+ 3 physical damage with autoattack(10000.0 EU)";
	}		
