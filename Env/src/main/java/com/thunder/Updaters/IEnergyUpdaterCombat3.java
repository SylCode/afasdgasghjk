...
public class IEnergyUpdaterCombat3 extends IEnergyUpdater implements IEnergyAdd {
	
	IEnergyUpdaterCombat3(){
		super();
	...
	protected String getEffect(){
		return "+ 6 physical damage with autoattack(40000.0 EU)";
	}		
