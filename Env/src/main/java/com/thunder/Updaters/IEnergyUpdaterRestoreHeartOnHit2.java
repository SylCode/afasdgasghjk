...
public class IEnergyUpdaterRestoreHeartOnHit2 extends IEnergyUpdater implements IEnergyAdd {
	
	IEnergyUpdaterRestoreHeartOnHit2(){
		super();
	...
	protected String getUpdater(){	
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterRestoreHeartOnHit2.getupdater");
	}
	
	@Override
	protected String getType(){
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterRestoreHeartOnHit2.gettype");
	}
	
	@Override
	protected String getMatrix(){
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterRestoreHeartOnHit2.getmatrix");
	}
	
	@Override
	protected String getEffect(){
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterRestoreHeartOnHit2.geteffect");
	}		
