...
public class IEnergyUpdaterAddSpeedOnHit2 extends IEnergyUpdater implements IEnergyAdd {
	
	IEnergyUpdaterAddSpeedOnHit2(){
		super();
	...
	protected String getUpdater(){	
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterSpeedOnHit2.getupdater");
	}
	
	@Override
	protected String getType(){
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterSpeedOnHit2.gettype");
	}
	
	@Override
	protected String getMatrix(){
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterSpeedOnHit2.getmatrix");
	}
	
	@Override
	protected String getEffect(){
		return StatCollector.translateToLocal("tag.updaters.EnergyUpdaterSpeedOnHit2.geteffect");
	}		
